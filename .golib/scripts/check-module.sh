...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-adaptive-throttle" &&
                "${module_path}" != github.com/faustbrian/go-adaptive-throttle/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-adaptive-throttle"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
